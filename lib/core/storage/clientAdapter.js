...
class ClientAdapter {
  ...
  async createIndex (index) {
    ...
    await this._indexCache.add({ index, scope: this._client.scope });
  ...
  async createCollection (index, collection, config) {
    ...
    await this._indexCache.add({ collection, index, scope: this._client.scope });
  ...
  async deleteIndex (index) {
    ...
    await this._indexCache.remove({ index, scope: this._client.scope });
  ...
  async deleteIndexes (indexes) {
    ...
    await Promise.all(
      indexes.map(index => this._indexCache.remove({
        index,
