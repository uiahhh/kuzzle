...
module.exports = [
  ...
  // We need to expose a GET method for "login" action in order to make
  // authentication protocol like Oauth2 or CAS work:
  ...
  {verb: 'get', url: '/cluster/_health', controller: 'cluster', action: 'health'},
  {verb: 'get', url: '/cluster/_status', controller: 'cluster', action: 'status'},
  ...
  {verb: 'post', url: '/cluster/_reset', controller: 'cluster', action: 'reset'},
